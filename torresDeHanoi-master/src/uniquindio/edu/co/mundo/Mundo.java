...
public class Mundo extends JPanel implements ActionListener, MouseListener {
    ...
    public Mundo() throws IOException {
        ...
        labelPasos = new JLabel("Minimo de Movimentos: " + hanoi.getContador());
        labelPasos.setBounds(700, 130, 180, 10);
        this.add(labelPasos);

        //Label que muestra el numero de pasos que ah echo el jugador
        pasosEchos = new JLabel("Número de movimentos: ");
        ...
        nombreTorre1 = new JLabel("TORRE UM");
        ...
        nombreTorre2 = new JLabel("TORRE DOIS");
